...
public class Timeline {
	...
	/**
	 * Represents a time line key in a Spriter SCML file. A key holds an {@link #id}, a {@link #time}, a {@link #spin}, an {@link #object()}
	 * and a {@link #curve}.
	 * 
	 * @author Trixt0r
	 *
	...
	public static class Key {
		...
		public static class Bone {
			 ...
			 *            the new angle
			 * @param scaleX
			 *            the new scale in x direction
			 * @param scaleY
			 *            the new scale in y direction
			 * @param pivotX
		...
		public static class Object extends Bone {
			 ...
			 *            the new alpha value
			 * @param folder
			 *            the new folder index
			 * @param file
			 *            the new file index
			 */
			public void set(float x, float y, float angle, float scaleX, float scaleY, float pivotX, float pivotY, float alpha, int folder,
					int file) {
