...
/**
 * Represents a folder in a Spriter SCML file. A folder has at least an {@link #id}, {@link #name} and {@link #files} may be empty. An
 * instance of this class holds an array of {@link File} instances. Specific {@link File} instances can be accessed via the corresponding
 * methods, i.e getFile().
 * 
 * @author Trixt0r
 *
...
public class Folder {
	...
	public File getFile(String name) {
		final int index = getFileIndex(name);
		if (index >= 0) {
