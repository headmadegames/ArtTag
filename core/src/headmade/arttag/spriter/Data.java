...
/**
 * Represents all the data which necessary to animate a Spriter generated SCML file. An instance of this class holds {@link Folder}s and
 * {@link Entity} instances. Specific {@link Folder} and {@link Entity} instances can be accessed via the corresponding methods, i.e.
 * getEntity() and getFolder().
 * 
 * @author Trixt0r
 *
 */
public class Data {
	...
	public Folder getFolder(String name) {
		final int index = getFolderIndex(name);
		if (index >= 0) {
	...
	public Entity getEntity(String name) {
		final int index = getEntityIndex(name);
		if (index >= 0) {
	 ...
	 * 
	 * @param folder
	 *            {@link Folder} instance to search in.
	 * @param file
	 *            index of the file
	 ...
	 * @return the {@link File} instance in the given folder at the given file index
	 * @throws {@link
	 *             IndexOutOfBoundsException} if the folder or file index are out of range
	 */
