...
/**
 * Represents a file in a Spriter SCML file. A file has an {@link #id}, a {@link #name}. A {@link #size} and a {@link #pivot} point, i.e.
 * origin of an image do not have to be set since a file can be a sound file.
 * 
 * @author Trixt0r
 *
 */
