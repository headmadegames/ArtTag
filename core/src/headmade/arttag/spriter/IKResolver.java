...
public abstract class IKResolver {
	 ...
	 *            the target y value
	 * @param chainLength
	 *            number of parents which are affected
	 * @param effector
	 *            the actual effector where the resolved information has to be stored in.
	 */
	 ...
	 * 
	 * @param player
	 *            the player which gets affected.
	 ...
	 * 
	 * @param player
	 *            player to apply the resolving.
	 */
	public void resolve() {
		for (final Entry<IKObject, BoneRef> entry : this.ikMap.entrySet()) {
	...
	/**
	 * Adds the given object to the internal IKObject - Bone map. This means, the values of the given ik object affect the mapped bone.
	 * 
	 * @param ikObject
	 *            the ik object
	 * @param boneRef
	...
	/**
	 * Sets the tolerance distance of this resolver. The resolver should stop the algorithm if the distance to the set ik object is less
	 * than the tolerance.
	 * 
	 * @param tolerance
	 *            the tolerance
