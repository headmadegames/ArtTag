...
/**
 * Represents a 2D rectangle with left, top, right and bottom bounds. A rectangle is responsible for calculating its own size and checking
 * if a point is inside it or if it is intersecting with another rectangle.
 * 
 * @author Trixt0r
 *
 */
public class Rectangle {
	...
	public static boolean areIntersecting(Rectangle rect1, Rectangle rect2) {
		return rect1.isInside(rect2.left, rect2.top) || rect1.isInside(rect2.right, rect2.top) || rect1.isInside(rect2.left, rect2.bottom)
