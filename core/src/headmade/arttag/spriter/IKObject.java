...
public class IKObject extends Point {
	 ...
	 *             if the chain length is smaller than 0
	 */
	...
	/**
	 * Sets the number of iterations. The more iterations a {@link IKResolver} is asked to do, the more precise the result will be.
	 * 
	 * @param iterations
	 *            number of iterations
	 * @return this ik object for chained operations
	 * @throws SpriterException
	 *             if the number of iterations is smaller than 0
	 */
